...
var JDashApi = (function () {
    ...
    JDashApi.prototype.saveDashboardRoute = function (req, res, next) {
        ...
        var id = req.params.id;
        var model = req.body;
        var dashletRemovalsPromise = this.provider.getDashboard(principal.appid, id).then(function (dashboardResult) {
            ...
            return _this.provider.deleteDashlet(newDashletIds);
        });
    ...
    JDashApi.prototype.createDashboardRoute = function (req, res, next) {
        ...
        this.provider.createDashboard(principal.appid, newModel).then(function (result) { return res.send(result); }).catch(function (err) { return next(err); });
    };
